...
def makeTable(pairs):
    ...
    print ''
    for key in sorted(pairs):
        #!!! It appears this will miss any phonemes that occur only as the second phoneme in a pair (because they won't be in sorted(pairs))
        #!!! Note the missing value for 'HH' in your sample output
