...
def phonemeList(list):
    ...
    #!!! It's best to avoid naming variables list and dict. Unlike string, these are sometimes reserved words.
    for word in list:
        ...
        if word in dict:
            ...
            #!!! The appending could happen right here. No need for futher ifs or elses; if the word isn't in the dictionary, nothing happens and you move to the next iteration of the loop.
        else:
            pass
        if phonemeRep != None:
...
def fileToPhoneme(path):
    ...
    #!!! Excellent use of a wrapper function.
